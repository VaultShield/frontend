...
const Welcome = () => {
  ...
  return (
    <div className="w-full pt-4 md:pl-2 sm:pr-4 lg:pr-8 h-full ">
      <main
        className={`rounded-md flex flex-col items-center h-full max-h-[1400px] max-w-[2100px] mr-2  pb-0 p-0 bg-blueLigth-200 overflow-x-hidden `}
      >
